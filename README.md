...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**create_access_token**](docs/DefaultApi.md#create_access_token) | **POST** /v1/access-token | Creates an admin token
*DefaultApi* | [**delete_access_token**](docs/DefaultApi.md#delete_access_token) | **DELETE** /v1/access-token | Deletes an access token
*DefaultApi* | [**health_check**](docs/DefaultApi.md#health_check) | **GET** /v1/health | Checks the health of the API
*DefaultApi* | [**list_access_tokens**](docs/DefaultApi.md#list_access_tokens) | **GET** /v1/access-token | Lists access tokens
*DefaultApi* | [**resolve_data_by_domain**](docs/DefaultApi.md#resolve_data_by_domain) | **GET** /v1/resolve/{domain} | Resolves wallets and DNS records for a domain
