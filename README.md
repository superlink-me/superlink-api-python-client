...
*ResolutionApi* | [**remove_reverse_resolution_address**](docs/ResolutionApi.md#remove_reverse_resolution_address) | **DELETE** /v1/reverse | Assigns a reverse resolution address from a domain
...
*ResolutionApi* | [**set_reverse_resolution_address**](docs/ResolutionApi.md#set_reverse_resolution_address) | **POST** /v1/reverse | Assigns an address to a domain for reverse resolution
