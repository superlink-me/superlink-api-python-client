...
------------- | ------------- | -------------
[**resolve_address_get**](ResolutionApi.md#resolve_address_get) | **GET** /v1/reverse/{address} | Resolves wallets and DNS records for an address
[**resolve_address_post**](ResolutionApi.md#resolve_address_post) | **POST** /v1/reverse | Assigns an address to a domain for reverse resolution
...
# **resolve_address_get**
> ApiResolveDomainResponse resolve_address_get(address, nameservice=nameservice)
...
with superlink.ApiClient(configuration) as api_client:
    ...
    try:
        # Resolves wallets and DNS records for an address
        api_response = api_instance.resolve_address_get(address, nameservice=nameservice)
        print("The response of ResolutionApi->resolve_address_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResolutionApi->resolve_address_get: %s\n" % e)
```
...
with superlink.ApiClient(configuration) as api_client:
    ...
    try:
        # Assigns an address to a domain for reverse resolution
        api_instance.resolve_address_post(request)
    except Exception as e:
        print("Exception when calling ResolutionApi->resolve_address_post: %s\n" % e)
```
