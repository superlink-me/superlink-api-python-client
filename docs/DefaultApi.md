...
------------- | ------------- | -------------
[**create_access_token**](DefaultApi.md#create_access_token) | **POST** /v1/access-token | Creates an admin token
[**delete_access_token**](DefaultApi.md#delete_access_token) | **DELETE** /v1/access-token | Deletes an access token
[**health_check**](DefaultApi.md#health_check) | **GET** /v1/health | Checks the health of the API
[**list_access_tokens**](DefaultApi.md#list_access_tokens) | **GET** /v1/access-token | Lists access tokens
[**resolve_data_by_domain**](DefaultApi.md#resolve_data_by_domain) | **GET** /v1/resolve/{domain} | Resolves wallets and DNS records for a domain
...
with superlink.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->delete_access_token: %s\n" % e)
```
...
with superlink.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DefaultApi->list_access_tokens:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->list_access_tokens: %s\n" % e)
```
...
with superlink.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DefaultApi->resolve_data_by_domain:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->resolve_data_by_domain: %s\n" % e)
```
