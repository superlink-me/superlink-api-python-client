...
class DefaultApi(object):
    ...
    @validate_arguments
    def create_access_token(self, request : Annotated[ApiAccessTokenCreateRequest, Field(..., description="access token create request")], **kwargs) -> ApiAccessTokenResponse:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the create_access_token_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.create_access_token_with_http_info(request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_access_token_with_http_info(self, request : Annotated[ApiAccessTokenCreateRequest, Field(..., description="access token create request")], **kwargs) -> ApiResponse:  # noqa: E501
        """Creates an admin token  # noqa: E501
    ...
    @validate_arguments
    def delete_access_token(self, request : Annotated[ApiAccessTokenDeleteRequest, Field(..., description="access token delete request")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the delete_access_token_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.delete_access_token_with_http_info(request, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_access_token_with_http_info(self, request : Annotated[ApiAccessTokenDeleteRequest, Field(..., description="access token delete request")], **kwargs) -> ApiResponse:  # noqa: E501
        """Deletes an access token  # noqa: E501
    ...
    @validate_arguments
    def health_check(self, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def list_access_tokens(self, **kwargs) -> ApiAccessTokenResponse:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the list_access_tokens_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.list_access_tokens_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def list_access_tokens_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Lists access tokens  # noqa: E501
    ...
    @validate_arguments
    def resolve_data_by_domain(self, domain : Annotated[StrictStr, Field(..., description="firstname.lastname")], **kwargs) -> ApiResolveDomainResponse:  # noqa: E501
        ...
        >>> thread = api.resolve_data_by_domain(domain, async_req=True)
        >>> result = thread.get()
        ...
        return self.resolve_data_by_domain_with_http_info(domain, **kwargs)  # noqa: E501

    @validate_arguments
    def resolve_data_by_domain_with_http_info(self, domain : Annotated[StrictStr, Field(..., description="firstname.lastname")], **kwargs) -> ApiResponse:  # noqa: E501
        """Resolves wallets and DNS records for a domain  # noqa: E501
        ...
        >>> thread = api.resolve_data_by_domain_with_http_info(domain, async_req=True)
        >>> result = thread.get()
