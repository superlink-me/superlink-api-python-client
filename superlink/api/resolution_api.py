...
class ResolutionApi(object):
    ...
    @validate_arguments
    def resolve_address_get(self, address : Annotated[StrictStr, Field(..., description="0x1234561234556")], nameservice : Annotated[Optional[StrictStr], Field(description="superlink")] = None, **kwargs) -> ApiResolveDomainResponse:  # noqa: E501
        ...
        >>> thread = api.resolve_address_get(address, nameservice, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the resolve_address_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.resolve_address_get_with_http_info(address, nameservice, **kwargs)  # noqa: E501

    @validate_arguments
    def resolve_address_get_with_http_info(self, address : Annotated[StrictStr, Field(..., description="0x1234561234556")], nameservice : Annotated[Optional[StrictStr], Field(description="superlink")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Resolves wallets and DNS records for an address  # noqa: E501
        ...
        >>> thread = api.resolve_address_get_with_http_info(address, nameservice, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method resolve_address_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def resolve_address_post(self, request : Annotated[ApiSetReverseAddressRequest, Field(..., description="set reverse address request")], **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.resolve_address_post(request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the resolve_address_post_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.resolve_address_post_with_http_info(request, **kwargs)  # noqa: E501

    @validate_arguments
    def resolve_address_post_with_http_info(self, request : Annotated[ApiSetReverseAddressRequest, Field(..., description="set reverse address request")], **kwargs) -> ApiResponse:  # noqa: E501
        """Assigns an address to a domain for reverse resolution  # noqa: E501
        ...
        >>> thread = api.resolve_address_post_with_http_info(request, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method resolve_address_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
