...
class ResolutionApi:
    ...
    @validate_arguments
    def resolve_data_by_domain(self, domain : Annotated[StrictStr, Field(description="firstname.lastname")], nameservices : Annotated[Optional[List[StrictStr]], Field(description="superlink,ens,ud")] = None, coins : Annotated[Optional[List[StrictStr]], Field(description="BTC,ETH,MATIC")] = None, **kwargs) -> ApiResolveDomainResponse:  # noqa: E501
