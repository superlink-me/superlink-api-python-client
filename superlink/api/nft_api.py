...
class NftApi(object):
    ...
    def get_token_image_by_domain(self, domain : Annotated[StrictStr, Field(..., description="firstname.lastname")], **kwargs) -> str:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_token_image_by_domain_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def get_token_metadata_by_domain(self, domain : Annotated[StrictStr, Field(..., description="firstname.lastname")], **kwargs) -> ApiDomainMetadataResponse:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_token_metadata_by_domain_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
