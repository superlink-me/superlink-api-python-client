...
class PartnerApi(object):
    ...
    @validate_arguments
    def partner_purchases(self, **kwargs) -> ApiPurchaseListResponse:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the partner_purchases_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.partner_purchases_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def partner_purchases_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Returns a list of all purchases  # noqa: E501
