...
class MarketApi(object):
    ...
    def market_purchase(self, request : Annotated[ApiPurchaseRequest, Field(..., description="purchase request")], **kwargs) -> ApiMarketPurchaseResponse:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the market_purchase_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def market_search(self, query : Annotated[StrictStr, Field(..., description="johndoe")], **kwargs) -> ApiMarketSearchResponse:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the market_search_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
