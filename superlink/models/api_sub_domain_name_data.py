...
class ApiSubDomainNameData(BaseModel):
    """
    ApiSubDomainNameData
    """ # noqa: E501
    addresses: Optional[Dict[str, StrictStr]] = None
    contenthash: Optional[StrictStr] = None
    text: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["addresses", "contenthash", "text"]
