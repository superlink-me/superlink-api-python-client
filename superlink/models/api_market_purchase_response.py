...
class ApiMarketPurchaseResponse(BaseModel):
    ...
    stripe_checkout_session: Optional[StrictStr] = Field(default=None, alias="stripeCheckoutSession")
    ...
    __properties: ClassVar[List[str]] = ["checkoutId", "orderId", "stripeCheckoutSession", "stripeCustomerId", "stripeEphemeralKey", "stripePublishableKey"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stripeCheckoutSession": obj.get("stripeCheckoutSession"),
