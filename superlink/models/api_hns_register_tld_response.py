...
class ApiHNSRegisterTLDResponse(BaseModel):
    """
    ApiHNSRegisterTLDResponse
    """ # noqa: E501
    records: Optional[ApiHNSBlockchainRecords] = None
    tld: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["records", "tld"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of records
        if self.records:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": ApiHNSBlockchainRecords.from_dict(obj["records"]) if obj.get("records") is not None else None,
            "tld": obj.get("tld")
        })
        return _obj
