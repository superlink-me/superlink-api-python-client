...
class ApiMarketCryptoEstimationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["estimations", "fiatCurrency", "region"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "estimations": [ApiMarketCryptoEstimation.from_dict(_item) for _item in obj["estimations"]] if obj.get("estimations") is not None else None,
