...
class ApiHNSCreateDomainWithWalletRequest(BaseModel):
    """
    ApiHNSCreateDomainWithWalletRequest
    """ # noqa: E501
    addresses: Optional[Dict[str, StrictStr]] = None
    ...
    __properties: ClassVar[List[str]] = ["addresses", "domain", "message", "ownerAddress", "signedMessage"]
