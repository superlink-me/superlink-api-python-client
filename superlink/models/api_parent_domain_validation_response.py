...
class ApiParentDomainValidationResponse(BaseModel):
    """
    ApiParentDomainValidationResponse
    """ # noqa: E501
    parent_domain: Optional[StrictStr] = Field(default=None, alias="parentDomain")
    reason: Optional[StrictStr] = None
    status: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["parentDomain", "reason", "status"]
