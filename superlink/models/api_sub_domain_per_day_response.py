...
class ApiSubDomainPerDayResponse(BaseModel):
    """
    ApiSubDomainPerDayResponse
    """ # noqa: E501
    aggregates: Optional[List[ApiSubDomainPerDayCount]] = None
    next_pagination_token: Optional[StrictStr] = Field(default=None, alias="nextPaginationToken")
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["aggregates", "nextPaginationToken", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aggregates": [ApiSubDomainPerDayCount.from_dict(_item) for _item in obj["aggregates"]] if obj.get("aggregates") is not None else None,
            "nextPaginationToken": obj.get("nextPaginationToken"),
            "total": obj.get("total")
        })
        return _obj
