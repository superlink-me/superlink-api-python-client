...
class ApiPurchaseRequest(BaseModel):
    ...
    ApiPurchaseRequest
    """
    customer_email_address: Optional[StrictStr] = Field(None, alias="customerEmailAddress")
    customer_name: Optional[StrictStr] = Field(None, alias="customerName")
    ...
    __properties = ["customerEmailAddress", "customerName", "domain", "ownerAddress", "stripeConnectedAccountId"]
    ...
    def from_dict(cls, obj: dict) -> ApiPurchaseRequest:
        ...
        _obj = ApiPurchaseRequest.parse_obj({
            "customer_email_address": obj.get("customerEmailAddress"),
