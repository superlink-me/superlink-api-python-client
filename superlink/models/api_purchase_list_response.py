...
class ApiPurchaseListResponse(BaseModel):
    ...
    """
    purchases: Optional[conlist(ApiPurchaseResponse)] = None
    __properties = ["purchases"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiPurchaseListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiPurchaseListResponse:
        """Create an instance of ApiPurchaseListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiPurchaseListResponse.parse_obj(obj)

        _obj = ApiPurchaseListResponse.parse_obj({
