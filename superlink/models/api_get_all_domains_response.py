...
class ApiGetAllDomainsResponse(BaseModel):
    """
    ApiGetAllDomainsResponse
    """ # noqa: E501
    domains: Optional[List[ApiDomainBasicInformation]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "domains": [ApiDomainBasicInformation.from_dict(_item) for _item in obj["domains"]] if obj.get("domains") is not None else None
        })
        return _obj
