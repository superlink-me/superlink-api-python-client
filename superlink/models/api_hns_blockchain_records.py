...
class ApiHNSBlockchainRecords(BaseModel):
    """
    ApiHNSBlockchainRecords
    """ # noqa: E501
    a: Optional[StrictStr] = None
    ds1: Optional[StrictStr] = None
    ds2: Optional[StrictStr] = None
    ds4: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["a", "ds1", "ds2", "ds4"]
