...
from openapi_client.models.api_resolve_domain_response import ApiResolveDomainResponse  # noqa: E501
...
class TestApiResolveDomainResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = openapi_client.models.api_resolve_domain_response.ApiResolveDomainResponse()  # noqa: E501
        if include_optional :
            return ApiResolveDomainResponse(
                ...
                provider = '', 
                txt_records = [
                    openapi_client.models.api/txt_record.api.TXTRecord(
                        key = '', 
                        value = '', )
                    ], 
                wallets = [
